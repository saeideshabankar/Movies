...
class RecyclerTopRatedAdapter constructor(
    private val context: Context,
    private val moviesListModel: MutableList<MoviesListModel.Result>
) :
    RecyclerView.Adapter<RecyclerTopRatedAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerTopRatedAdapter.ViewHolder, position: Int) {
        ...
        fun bindData(moviesListModel: MoviesListModel.Result) {
            ...
            bestToAllDetailsBtn.setOnClickListener {
                ...
                it.findNavController()
                    .navigate(R.id.action_topRatedMovieFragment_to_detailsFragment, bundle)
