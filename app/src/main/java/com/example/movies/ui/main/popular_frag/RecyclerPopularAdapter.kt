...
import com.example.movies.utils.showImageGlide

class RecyclerPopularAdapter constructor(
    private val context: Context,
    private val moviesListModel: MutableList<MoviesListModel.Result>
) :
    RecyclerView.Adapter<RecyclerPopularAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerPopularAdapter.ViewHolder, position: Int) {
            ...
            /*    Glide.with(context)
              ...
              bestToAllDetailsBtn.setOnClickListener {
                  ...
                  it.findNavController()
                      .navigate(R.id.action_PopularFragment_to_detailsFragment, bundle)
